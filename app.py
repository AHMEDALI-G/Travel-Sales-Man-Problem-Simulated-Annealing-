...
# ============================================================
# HELPER FUNCTIONS  (path cleaning, distance, city generation)
# ============================================================
...
#
#   ████████████████████████████████████████████████████████
#         SIMULATED ANNEALING ALGORITHM  ← SHOW TEACHER
#   ████████████████████████████████████████████████████████
#
#   IDEA:
#     Imagine you are hiking and trying to find the lowest
#     valley. Instead of always going downhill, sometimes
#     you go uphill too — so you don't get stuck in a small
#     dip and miss the deepest valley.
#
#   STEPS EACH ITERATION:
#     1. Take current path, swap 2 random cities → neighbour
#     2. If neighbour distance is SHORTER  → accept it always
#     3. If neighbour distance is LONGER   → accept it with
#        probability = e^(-difference / temperature)
#        (high temp = risky, low temp = careful)
#     4. Cool down temperature slowly each step
#     5. Always remember the best path ever seen
#
# ============================================================

def make_neighbour(path):
    # Swap two random cities (never touch HOME city at index 0)
    if len(path) <= 2:
        return path[:]
    new_path    = path[:]
...
def annealing_loop():
    while is_running:
        run_one_step()
        time.sleep(0.03)        # run every 30ms in background
...
# ============================================================
# API ROUTES  (frontend index.html talks to these URLs)
# ============================================================
